...
const Admin = () => {
  ...
  return (
    <div className=' bg-gray-400 px-4 py-8 max-w-7xl mx-auto mt-16'>
      ...
      <Link to="/admin/food/create" className='bg-blue-600 hover:bg-blue-900 text-white py-2 px-4 font-medium rounded-lg shadow-md'>
        Add Item +
      </Link>
                ...
                <td className='py-3 px-5'>
                  <div className='flex justify-center gap-x-4'>
                    <div className='flex justify-center gap-x-1'>
                      <Link to={`/admin/food/edit/${food._id}`} className='bg-green-500 hover:bg-green-900 text-white py-2 px-4 font-medium rounded-l-lg text-sm'>Edit</Link>
