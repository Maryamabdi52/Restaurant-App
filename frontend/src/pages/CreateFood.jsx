...
const CreateFood = () => {
    ...
    const handleSaveFood = async () => {
        ...
        // Validate food name: only allows letters and spaces
        const namePattern = /^[A-Za-z\s]+$/;
        if (!namePattern.test(name)) {
            enqueueSnackbar('Error: Only characters are allowed in the food name column.', { variant: 'warning' });
            return;
        }
        ...
        <div className='p-6 bg-gray-50 min-h-screen flex justify-center '>
            ...
            <div className='container max-w-lg shadow-lg rounded-lg p-5 bg-white'>
                ...
                <div className='space-y-4'>
                    ...
                    <button onClick={handleSaveFood} className='w-full bg-blue-500 hover:bg-blue-800 text-white py-2 px-4 rounded-md'>Save</button>
                </div>
            </div>
        </div>
    );
